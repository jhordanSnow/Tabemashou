...
INSERT INTO [PARAMETER](PARAMETER, VALUE) VALUES('SELL_TAX',13)
...
CREATE TABLE [TypesPerDish] (
  ...
  CONSTRAINT FK_IdDish FOREIGN KEY(IdDish) REFERENCES [Dish]  ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT FK_IdDishType FOREIGN KEY(IdType) REFERENCES [Type] ON UPDATE CASCADE
);
...
CREATE TABLE [DishesByCheck] (
  [UnitaryPrice] SMALLMONEY NOT NULL,
